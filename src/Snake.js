class Snake {
     ...
     * @param {string} direction направление может down, up, left, right.
     * @throws {Error} при передаче не корректного направление вырасывается ошибка.
     */
    ...
    /**
     * Добавляет ячейку перед существующим
     * положением головы и удаляет одну ячейку в хвосте.
     * @param {Object} newHeadCoords - новые координаты головы
     */
    writeStep(newHeadCoords) {
