class Settings {
     ...
     * @param {} params.rowsCount - количество строк игрового поля.
     * @param {} params.colsCount - количество колонок игрового поля.
     * @param {} params.speed - скорость перемещения змейки.
     * @param {} params.winLength - какую длину надо наесть, чтобы выиграть.
